...
- 不要等一个并不存在的 editor 成本 slash command；这章主要还是看 dashboard 和 spending limit。
- 如果你已经开始用 web / mobile / Slack / GitHub / Linear / API 这些后台入口，要把 follow-up 和并发一起算进 usage。
...
- 不要把 API 层的 256 active agents 想象成“默认就该开满”的能力。
