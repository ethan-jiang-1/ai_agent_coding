...
8. `Phase 7. Promotion / Merge / Hold Decision`
...
1. 开始整个 run 之前
2. 进入 `Phase 1 Global Baseline And Candidate Frame`
3. 完成 `Phase 1 Global Baseline And Candidate Frame`
4. 每次进入一个新的工具 phase
5. 完成每个工具 phase，也就是完成对应工具的 `Step 2F Tool Exit Summary`
6. 进入 `Phase 6 Cross-Tool Convergence`
7. 完成 `Phase 6 Cross-Tool Convergence`
8. 完成 `Phase 7 Promotion / Merge / Hold Decision`
9. 完成 `Phase 8 Landing Design`
10. 完成 `Phase 9 Final Conclusion`
