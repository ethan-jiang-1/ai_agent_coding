...
- `affected_tools`
- `proposed_landing`
  - new practice / merge target / reference-only / no landing
...
- `change_type`
  - `Promote / Merge / Reference-only / No-op`
- `confidence`
- `rationale`
...
- 同时生成 `90_review_queue/apply_matrix/`，明确哪些候选建议 apply 到哪一个正式工具目录、哪个文件、哪个章节、采用哪种改法
- 更新 `INDEX.md` 与 `STATUS_LOG.md`
